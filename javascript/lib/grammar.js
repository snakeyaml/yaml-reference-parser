...
(function() {
  ...
  global.Grammar = Grammar = (function() {
    var b_carriage_return, b_char, b_char_s, b_comment, b_line_feed, c_byte_order_mark, c_directives_end, c_document_end, c_flow_indicator, c_flow_indicator_s, c_indicator, c_named_tag_handle, c_nb_comment_text, c_ns_esc_char, c_ns_local_tag_prefix, c_primary_tag_handle, c_printable, c_quoted_quote, c_secondary_tag_handle, c_tag_handle, line_break, nb_char, nb_double_char, nb_json, nb_ns_single_in_line, nb_single_char, ns_anchor_name, ns_ascii_letter_s, ns_char, ns_dec_digit, ns_dec_digit_s, ns_directive_name, ns_directive_parameter, ns_double_char, ns_global_tag_prefix, ns_hex_digit, ns_single_char, ns_tag_char, ns_uri_char, ns_word_char, ns_word_char_s, r, re_b_char, re_b_comment, re_c_directives_end, re_c_document_end, re_c_forbidden, re_c_ns_alias_node, re_c_ns_anchor_property, re_c_ns_tag_property, re_c_tag_handle, re_l_comment, re_l_trail_comments, re_line_break, re_nb_char, re_nb_double_one_line, re_nb_ns_double_in_line, re_nb_ns_single_in_line, re_nb_single_one_line, re_ns_char, re_ns_double_char, re_ns_flow_map_entry, re_ns_flow_pair, re_ns_plain_first1, re_ns_plain_first2, re_ns_plain_safe_in, re_ns_reserved_directive, re_ns_tag_directive, re_ns_tag_prefix, re_ns_yaml_directive, re_ns_yaml_version, re_s_b_comment, re_s_indent, re_s_separate_in_line, re_s_single_next_line, re_s_white, s_indent_n, s_separate_spaces, s_space, s_white, start_of_line, ws_lookahead;
    ...
    class Grammar {
      ...
      s_separate_in_line() {
        ...
        return this.rgx(re_s_separate_in_line);
      }
      ...
      s_line_prefix(n, c) {
        ...
        return this.case(c, {
          'block-in': this.rgx(s_indent_n(n)),
          'block-out': this.rgx(s_indent_n(n)),
      ...
      s_flow_line_prefix(n) {
        ...
        return this.all(this.rgx(s_indent_n(n)), this.rep(0, 1, this.s_separate_in_line));
      }
      ...
      s_b_comment() {
        ...
        return this.all(this.rep(0, 1, this.all(this.s_separate_in_line, this.rgx(re_s_b_comment, true))), this.rgx(re_b_comment, true));
      }

      l_comment() {
        // debug_rule("l_comment")
        return this.all(this.s_separate_in_line, this.rgx(re_l_comment));
      }
      ...
      ns_tag_directive() {
        ...
        return this.all(this.rgx(re_ns_tag_directive), this.c_tag_handle, this.s_separate_in_line, this.ns_tag_prefix);
      }
      ...
      c_ns_tag_property() {
        ...
        return this.rgx(re_c_ns_tag_property);
      }
      ...
      s_single_next_line(n) {
        ...
        return this.all([this.s_flow_folded, n], this.rep(0, 1, this.all(this.rgx(re_s_single_next_line), this.any([this.s_single_next_line, n], this.rep(0, null, this.s_white)))));
      }
      ...
      ns_plain_first(c) {
        ...
        return this.any(this.rgx(re_ns_plain_first1), this.all(this.rgx(re_ns_plain_first2), this.chk('=', [this.ns_plain_safe, c])));
      }
      ...
      l_nb_literal_text(n) {
        ...
        return this.all(this.rep(0, null, [this.l_empty, n, "block-in"]), this.rgx(s_indent_n(n)), this.rep2(1, null, this.nb_char));
      }
      ...
      s_nb_folded_text(n) {
        ...
        return this.all(this.rgx(s_indent_n(n)), this.ns_char, this.rep(0, null, this.nb_char));
      }
      ...
      s_nb_spaced_text(n) {
        ...
        return this.all(this.rgx(s_indent_n(n)), this.s_white, this.rep(0, null, this.nb_char));
      }
    ...
    r = function(rgx) {
      ...
      rgx = String(rgx).slice(1, -1);
      chars = rgx.slice(1, -1);
      regexp = RegExp(`${rgx}`, "yum");
    ...
    // b-carriage-return ::=
    //   x:D
    [b_carriage_return] = r(/\x0D/);

    // [026]
    // b-char ::=
    //   b-line-feed | b-carriage-return
    [b_char, re_b_char, b_char_s] = r(RegExp(`[${b_line_feed}${b_carriage_return}]`));
    ...
    //   | b-carriage-return
    //   | b-line-feed
    [line_break, re_line_break] = r(RegExp(`(?:(?:${b_carriage_return}${b_line_feed})|${b_carriage_return}|${b_line_feed})`));
    ...
    // s-white ::=
    //   s-space | s-tab
    [s_white, re_s_white] = r(RegExp(`[${s_space}\\t]`));
    ...
    //   | ';' | '/' | '?' | ':' | '@' | '&' | '=' | '+' | '$' | ','
    //   | '_' | '.' | '!' | '~' | '*' | ''' | '(' | ')' | '[' | ']'
    [ns_uri_char] = r(RegExp(`(?:%${ns_hex_digit}{2}|[${ns_word_char_s}\\u0023;/?:@&=+$,_.!~*'()[\\]])`));
    ...
    [c_ns_esc_char] = r(RegExp(`\\\\(?:[0abt\\u0009nvfre\\u0020"/\\\\N_LP]|x${ns_hex_digit}{2}|u${ns_hex_digit}{4}|U${ns_hex_digit}{8})`));
    ...
    [s_separate_spaces] = r(RegExp(`${s_white}+`));

    start_of_line = '^';

    [s_separate_spaces, re_s_separate_in_line] = r(RegExp(`(?:${s_separate_spaces}|${start_of_line})`));

    // [075]
    // c-nb-comment-text ::=
    //   '#' nb-char*
    [c_nb_comment_text] = r(RegExp(`(?:\\u{23}${nb_char}*)`, "u"));

    // [076]
    // b-comment ::=
    //   b-non-content | <end_of_file>
    [b_comment, re_b_comment] = r(RegExp(`(?:${line_break // UNTESTED
}|$)`));
    ...
    ] = r(RegExp(`${ns_directive_name}(?:${s_separate_spaces}${ns_directive_parameter})*`, "u"));
    ...
    [
      ...
      re_ns_yaml_version
    ] = r(RegExp(`${ns_dec_digit}+\\.${ns_dec_digit}+`));
    ...
    ] = r(RegExp(`(?:YAML${s_separate_spaces})`));
    ...
    [
      ...
      re_ns_tag_directive
    ] = r(RegExp(`TAG${s_separate_spaces}`));
    ...
    [
      ...
      re_ns_tag_prefix
    ] = r(RegExp(`(?:${c_ns_local_tag_prefix}|${ns_global_tag_prefix})`));
    ...
    [
      ...
      //   | c-ns-shorthand-tag
      //   | c-non-specific-tag
      re_c_ns_tag_property
    ] = r(RegExp(`(?:(!<${ns_uri_char}+>)|(${c_tag_handle}${ns_tag_char}+)|!)`));

    // [103]
    // ns-anchor-name ::=
    //   ns-anchor-char+
    [ns_anchor_name] = r(RegExp(`(?:(?!${c_flow_indicator})${ns_char})+`, "u"));
    ...
    [
      ...
      //   <followed_by_an_ns-plain-safe(c)> )
      re_ns_plain_first1
    ] = r(RegExp(`(?!${c_indicator})${ns_char}`, "u"));
    ...
    //   ns-flow-map-explicit-entry(n,c) )
    //   | ns-flow-map-implicit-entry(n,c)
    [ws_lookahead] = r(RegExp(`(?=$|${s_white}|${line_break})`));

    [, re_ns_flow_map_entry] = r(RegExp(`\\?${ws_lookahead}`));
    ...
    // c-directives-end ::=
    //   '-' '-' '-'
    [c_directives_end, re_c_directives_end] = r(RegExp(`---(?=$|${s_white}|${line_break})`));
    ...
    [
      ...
      re_c_forbidden
    ] = r(RegExp(`(?:${c_directives_end // UNTESTED
}|${c_document_end})(?:${b_char}|${s_white}|$)`));
